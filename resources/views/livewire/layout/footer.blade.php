        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-0">
                <a href="" class="flex items-center">
                    <img src="{{ asset($settings?->icon ? 'storage/' . $settings?->icon : 'logo.png') }}" class="mr-3 h-8" alt="{{ $settings->name ?? "Amanah Voice" }}" />
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">{{ $settings->name ?? "Amanah Voice" }}</span>
                </a>
            </div>
