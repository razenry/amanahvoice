<div class="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300 relative">
    ...
    <!-- Floating Share Button - SIMPLIFIED VERSION -->
    <div class="fixed bottom-6 right-6 z-[9999]">
        <!-- Main Share Button -->
        <button id="shareButton"
            class="w-14 h-14 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white rounded-full shadow-2xl flex items-center justify-center transition-all duration-300 hover:scale-110 group"
        ...
        <!-- Share Options Menu -->
        <div id="shareMenu" class="absolute bottom-16 right-0 hidden bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-3 min-w-[200px] border border-gray-200 dark:border-gray-700">
            <!-- Copy Link -->
    ...
    <script>
        ...
        document.addEventListener('click', function(event) {
            ...
            if (!shareContainer.contains(event.target) && !shareMenu.classList.contains('hidden')) {
                shareMenu.classList.add('hidden');
            }
        });
    </script>
